...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    c = CausalMultiHeadsAttention(d_model, num_heads, max_seq_len, theta)
    c.load_state_dict(
        {
            "Q": q_proj_weight,
            "K": k_proj_weight,
    ...
    return c(in_features, token_positions)
...
def run_transformer_block(
    ...
    t.load_state_dict(new_weight_dict)
...
def run_transformer_lm(
    ...
    new_weight_dict = {
        ...
        "out_norm.weight": weights["ln_final.weight"],
    ...
    for i in range(num_layers):
        prefix = f"layers.{i}."
        new_weight_dict |= {
            prefix + "ffn.w1.weight": weights[prefix + "ffn.w1.weight"],
            prefix + "ffn.w2.weight": weights[prefix + "ffn.w2.weight"],
            prefix + "ffn.w3.weight": weights[prefix + "ffn.w3.weight"],
            prefix + "ffn_norm.weight": weights[prefix + "ln2.weight"],
            prefix + "attn.Q": weights[prefix + "attn.q_proj.weight"],
            prefix + "attn.K": weights[prefix + "attn.k_proj.weight"],
            prefix + "attn.V": weights[prefix + "attn.v_proj.weight"],
            prefix + "attn.O.weight": weights[prefix + "attn.output_proj.weight"],
            prefix + "attn_norm.weight": weights[prefix + "ln1.weight"],
        }
...
def run_gradient_clipping(
    ...
    """
    grad_clipping(para=parameters, max_norm=max_l2_norm)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return run_bpe(input_path, vocab_size, special_tokens)
